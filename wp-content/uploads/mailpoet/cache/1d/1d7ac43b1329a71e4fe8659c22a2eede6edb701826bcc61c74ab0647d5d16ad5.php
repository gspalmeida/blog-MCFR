...
class __TwigTemplate_c6be8925fbfc492c908189ec19d7553b3038a540494ad3a0328605fab9e8577b extends Twig_Template
{
  ...
  <textarea placeholder=\"{{#if params.label_within}}{{ params.label }}{{#if params.required}} *{{/if}}{{/if}}\" disabled=\"disabled\" rows=\"{{#if params.lines}}{{ params.lines }}{{else}}1{{/if}}\">{{ params.text }}</textarea>
    ...
    {
        return new Twig_Source("", "form/templates/blocks/textarea.hbs", "/var/www/html/blog.mcfr.com.br/wp-content/plugins/mailpoet/views/form/templates/blocks/textarea.hbs");
    }
}
