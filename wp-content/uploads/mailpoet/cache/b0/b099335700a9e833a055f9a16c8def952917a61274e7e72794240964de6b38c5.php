...
class __TwigTemplate_a2b4fb87ca7f8d1b6debe6afbe08dba254d3465dc201beedb90fa33dc19d7661 extends Twig_Template
{
...
<input type=\"text\" disabled=\"disabled\" value=\"\" placeholder=\"{{#if params.label_within}}{{ params.label }}{{#if params.required}} *{{/if}}{{/if}}\" />";
    ...
    {
        return new Twig_Source("", "form/templates/blocks/text.hbs", "/var/www/html/blog.mcfr.com.br/wp-content/plugins/mailpoet/views/form/templates/blocks/text.hbs");
    }
}
