...
class FooClientInterface implements FacebookHttpClientInterface {
	...
	public function send( $url, $method, $body, array $headers, $timeOut ) {
		...
		"HTTP/1.1 1337 OK\r\nDate: Mon, 19 May 2014 18:37:17 GMT", '{"data":[{"id":"123","name":"Foo"},{"id":"1337","name":"Bar"}]}'
		);
	}
...
class FacebookTest extends \PHPUnit_Framework_TestCase {
	...
	public function testCurlHttpClientHandlerCanBeForced() {
		...
		'Facebook\HttpClients\FacebookCurlHttpClient', $fb->getClient()->getHttpClientHandler()
		);
	}
	...
	public function testStreamHttpClientHandlerCanBeForced() {
		...
		$fb		 = new Facebook( $config );
		$this->assertInstanceOf(
		'Facebook\HttpClients\FacebookStreamHttpClient', $fb->getClient()->getHttpClientHandler()
		);
	}
	...
	public function testGuzzleHttpClientHandlerCanBeForced() {
		...
		$fb		 = new Facebook( $config );
		$this->assertInstanceOf(
		'Facebook\HttpClients\FacebookGuzzleHttpClient', $fb->getClient()->getHttpClientHandler()
		);
	}
	...
	public function testPersistentDataHandlerCanBeForced() {
		...
		$fb		 = new Facebook( $config );
		$this->assertInstanceOf(
		'Facebook\PersistentData\FacebookMemoryPersistentDataHandler', $fb->getRedirectLoginHelper()->getPersistentDataHandler()
		);
	}
	...
	public function testMcryptCsprgCanBeForced() {
		...
		$fb		 = new Facebook( $config );
		$this->assertInstanceOf(
		'Facebook\PseudoRandomString\McryptPseudoRandomStringGenerator', $fb->getRedirectLoginHelper()->getPseudoRandomStringGenerator()
		);
	}
	...
	public function testOpenSslCsprgCanBeForced() {
		...
		$fb		 = new Facebook( $config );
		$this->assertInstanceOf(
		'Facebook\PseudoRandomString\OpenSslPseudoRandomStringGenerator', $fb->getRedirectLoginHelper()->getPseudoRandomStringGenerator()
		);
	}
	...
	public function testUrandomCsprgCanBeForced() {
		...
		$fb		 = new Facebook( $config );
		$this->assertInstanceOf(
		'Facebook\PseudoRandomString\UrandomPseudoRandomStringGenerator', $fb->getRedirectLoginHelper()->getPseudoRandomStringGenerator()
		);
	}
	...
	public function testCreatingANewRequestWillDefaultToTheProperConfig() {
		...
		$this->assertEquals(
		FacebookClient::BASE_GRAPH_URL_BETA, $fb->getClient()->getBaseGraphUrl()
		);
	}
	...
	public function testCanInjectCustomHandlers() {
		...
		$this->assertInstanceOf(
		'Facebook\Tests\FooClientInterface', $fb->getClient()->getHttpClientHandler()
		);
		$this->assertInstanceOf(
		'Facebook\Tests\FooPersistentDataInterface', $fb->getRedirectLoginHelper()->getPersistentDataHandler()
		);
		$this->assertInstanceOf(
		'Facebook\Tests\FooUrlDetectionInterface', $fb->getRedirectLoginHelper()->getUrlDetectionHandler()
		);
		$this->assertInstanceOf(
		'Facebook\Tests\FooBarPseudoRandomStringGenerator', $fb->getRedirectLoginHelper()->getPseudoRandomStringGenerator()
		);
	}
	...
	public function testPaginationReturnsProperResponse() {
		...
		], '/1337/photos', '\Facebook\GraphNodes\GraphUser'
		);
