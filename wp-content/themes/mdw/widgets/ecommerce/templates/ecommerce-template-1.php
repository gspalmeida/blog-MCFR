					...
					<div class="<?php echo $grid_class; ?> <?php echo get_theme_mod( "flex_cols", "no" ) == 'yes' ? 'flex-cols' : ''; ?> <?php echo $animation == 'None' ? '' : ( ' wow ' . $animation ); ?>">
						...
						<div class="card card-cascade narrower">
							...
							<div class="card-block text-xs-center">
								...
								<?php if ( $average != 0 ) { ?>
									<ul class="rating">
										<li><i class="fa fa-star<?php if ( $average < 1 ) echo "-o" ?>"></i></li>
										<li><i class="fa fa-star<?php if ( $average < 2 ) echo "-o" ?>"></i></li>
										<li><i class="fa fa-star<?php if ( $average < 3 ) echo "-o" ?>"></i></li>
										<li><i class="fa fa-star<?php if ( $average < 4 ) echo "-o" ?>"></i></li>
										<li><i class="fa fa-star<?php if ( $average < 5 ) echo "-o" ?>"></i></li>
									</ul>
								<?php } else { ?>
									<p><i><?php _e( 'No ratings', 'mdw' ) ?></i></p>
								<?php } ?>
								...
								<div class="card-footer">
									...
									<span class="right">
									  <!-- <a data-toggle="tooltip" data-placement="top" title="Share"><i class="fa fa-share-alt"></i></a> -->
										<a href="<?php echo home_url() . "/?add-to-cart=" . get_the_ID(); ?>" data-toggle="tooltip" data-placement="top" title="<?php _e( 'Add to Cart', 'mdw' ); ?>"> <i class="fa fa-shopping-cart"></i></a>
										<!-- <a data-toggle="tooltip" data-placement="top" title="Added to Wishlist"><i class="fa fa-heart"></i></a> -->
									</span>
								</div>
							</div>
							<!--/.Card content-->
