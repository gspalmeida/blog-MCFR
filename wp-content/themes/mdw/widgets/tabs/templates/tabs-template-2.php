...
<div class="row">
	...
	<ul class="nav nav-tabs md-pills pills-ins" role="tablist">
		<?php for ( $i = 1; $i <= $fieldCount; $i++ ) { ?>
				<li class="nav-item">
					<a class="nav-link <?php echo ($i == 1) ? 'active' : '' ?>" data-toggle="tab" href="#panel-template2-<?php echo $i; ?>" role="tab"><i class="<?php echo ${"icon_container_" . $i} ?>"></i> <?php echo ${"name_" . $i}; ?></a>
				</li>
			<?php } ?>
	</ul>
	...
	<div class="tab-content">
		...
		<?php for ( $i = 1; $i <= $fieldCount; $i++ ) { ?>
			<div class="tab-pane fade  <?php echo ($i == 1) ? 'in active' : '' ?>" id="panel-template2-<?php echo $i; ?>" role="tabpanel">
				<br>
