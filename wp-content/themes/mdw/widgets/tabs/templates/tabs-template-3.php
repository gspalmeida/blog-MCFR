    ...
    <section id="tabs" class="section col-md-12 team-section pt-3">
		...
		<div class="col-md-3">
			...
			<ul class="nav nav-tabs md-pills pills-ins" role="tablist">
				<?php for ( $i = 1; $i <= $fieldCount; $i++ ) { ?>
						<li class="nav-item">
							<a class="nav-link <?php echo ($i == 1) ? 'active' : '' ?>" data-toggle="tab" href="#panel-template3-<?php echo $i; ?>" role="tab"><i class="<?php echo ${"icon_container_" . $i} ?>"></i> <?php echo ${"name_" . $i}; ?></a>
						</li>
					<?php } ?>
			</ul>
		</div>
		...
		<div class="col-md-7">
			...
			<div class="tab-content vertical">
				<?php for ( $i = 1; $i <= $fieldCount; $i++ ) { ?>
					<div class="tab-pane fade <?php echo ($i == 1) ? 'in active' : '' ?>" id="panel-template3-<?php echo $i; ?>" role="tabpanel">
						<br>
