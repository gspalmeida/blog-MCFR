...
<div class="<?php echo $box_layout; ?>">
	...
	<section class="section team-section">
		...
		<?php for ( $i = 1; $i <= $amount; $i++ ) { ?>
			<div class="row">
				<?php if ( $i % 2 == 0 ) { ?>
					<div class="col-lg-7 text-xs-center text-sm-right mb-3">
					...
					<div class="col-lg-3 offset-lg-1 col-md-5 mb-r <?php echo $animation == 'None' ? '' : ( ' wow ' . $animation ); ?>" id="<?php echo $widget_id; ?>" data-post-id="<?php echo $widget_id; ?>">
