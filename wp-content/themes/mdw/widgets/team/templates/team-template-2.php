		...
		if ( strpos( $sidebar, 'sidebar' ) === false ) {
			...
			<div class="row text-xs-center">
				<?php for ( $i = 1; $i <= $amount; $i++ ) { ?>
					<div class="col-md-<?php echo floor( 12 / $amount ) ?> mb-r <?php echo $animation == 'None' ? '' : ( ' wow ' . $animation ); ?>" data-post-id="<?php echo $widget_id; ?>">
						<div class="avatar">
					...
					<?php for ( $i = 1; $i <= $amount; $i++ ) { ?>
						<div class="carousel-item <?php echo $i == '1' ? ' active ' : '' ?>"> 
							<div class="col-md-<?php echo floor( 12 / $amount ) ?> mb-r <?php echo $animation == 'None' ? '' : ( ' wow ' . $animation ); ?>" data-post-id="<?php echo $widget_id; ?>">
								...
								<div class="avatar">
									<img src="<?php echo ${"image_" . $i} ?>" style="height: 250px; width: 250px;">
								</div>
								<h4><?php echo ${"name_" . $i} ?></h4>
								<h5><?php echo ${"job_" . $i} ?></h5>
