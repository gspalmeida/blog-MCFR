...
$background_color_2 = isset( $instance[ 'background_color_2' ] ) ? $instance[ 'background_color_2' ] : '';
?>
    ...
    <div class="row">
		<?php for ( $i = 1; $i <= $fieldCount; $i++ ) { ?>
			...
			<div class="col-lg-<?php echo floor(12 / $fieldCount); ?> col-md-12 mb-r <?php echo $animation == 'None' ? '' : ( ' wow ' . $animation ); ?>">
				<!--Card-->
				<div class="card" <?php echo $i == 2 ? ' style="background-color:' . $background_color_2 . '!important"' : ''; ?>>
					...
					<div class="text-xs-center <?php echo $i == 2 ? ' white-text' : ''; ?>">
						<div class="card-block">
							...
							<a class="btn <?php echo $i == 2 ? ' btn-outline-white' : 'btn-primary'; ?>  btn-rounded" href="<?php echo ${'button_href_' . $i}; ?>" <?php echo ( ( $i != 2 && ${'icon_container_' . $i} != '' ) ? ( 'style="background-color:' . ${'icon_color_' . $i} . '"' ) : '' ); ?> ><?php echo ${'button_text_' . $i}; ?></a>
                            <?php } ?>
						</div>
					</div>
