...
?>" id="<?php echo $widget_id; ?>">
	...
	?>" data-template-version="blog_template_7">
				 <?php
	...
	<div id="dataForAjaxLoadMore">
		...
		<div data-social-buttons="<?php echo $social_buttons; ?>"></div>
		<div data-share-animation="<?php echo $share_animation; ?>"></div>
