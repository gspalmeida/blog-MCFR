 ...
 */
function get_mdw_blog_template_1( $params = array() ) {
	global $wpdb;
	...
	<div class="row" data-post-id="<?php the_ID(); ?>">
		<div class="col-md-5 mb-r <?php echo $params[ 'animation' ] == 'None' ? '' : ( ' wow ' . $params[ 'animation' ] ); ?>" <?php echo $params[ 'counter' ] % 2 == 0 ? 'style="float:right;"' : ""; ?>>
