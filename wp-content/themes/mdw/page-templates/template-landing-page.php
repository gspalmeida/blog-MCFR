...
<?php if ( is_active_sidebar( 'landing-page-intro' ) || is_active_sidebar( 'landing-page' ) ) : ?>
	<header <?php echo $back_to_the_top == "yes" ? " id='top-section'" : ""; ?> data-sidebar-type='landing-page-intro'>
		...
		?>
		<?php if ( is_active_sidebar( 'landing-page-intro' ) ) : ?>
			<?php dynamic_sidebar( 'landing-page-intro' ); ?>
		<?php endif; ?>
	</header>
	<?php
	...
	<main class="<?php echo $main_class; ?>"
		  data-sidebar-type='landing-page'>
...
<?php else: ?>
	<header data-sidebar-type='landing-page-intro' class="container"><h3><?php _e( "Please assign widgets to this Landing Page Intro Area in admin dashboard.", "mdw" ); ?></h3></header>
	<div data-sidebar-type='landing-page' class="container"><h3><?php _e( "Please assign widgets to this landing page in admin dashboard.", "mdw" ); ?></h3></div>
		<?php endif; ?>
